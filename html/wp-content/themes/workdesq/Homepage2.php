	...
	foreach ($homepage_blocks as $key => $value) :
		...
		switch ($key) :
			...
			<div class="flatintro" style="background:url(<?php echo $Introduction_bg ;?>) <?php echo $Introduction_color ;?>;overflow:auto;">
				...
				<div class="grid12 col">
					<h1 class="page-title1"><?php echo $smof_data['home2_homepage_intro_header'] ?></h1>

					<p class="page-title2"><?php echo do_shortcode($smof_data['home2_homepage_intro_text']) ?></p>
					<p class="centerbut">
  						<a href="<?php echo $smof_data['home2_homepage_intro_link'] ?>" target="_blank" class="new_intro_button color2"><?php echo $smof_data['home2_homepage_intro_link_text'] ?></a>

  						<a href="<?php echo $smof_data['home2_homepage_intro_link2'] ?>" target="_blank" class="new_intro_button color1"><?php echo $smof_data['home2_homepage_intro_link_text2'] ?></a>
  					</p>
				</div>
				</section>
			</div>
		...
		<div class="grid12 col">
			...
			case 'features':
				...
				<section class="container">
				<div class="grid12 col">
				<h1 class="page-title1" style="opacity: 1;">How it works</span></h1>
				&nbsp;
				</div>
...
<div class="grid12 col">
			...
			<?php } ?>
	<ul class="fade_testi" id="quote_fade">
...
case 'html1': ?>
         <?php 
			...
			<div class="flatintro" style="background:url(<?php echo $html1_bg ;?>) <?php echo $html1_color ;?>;overflow:auto;<?php echo $paralax_body;?>">
